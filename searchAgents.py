        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not hitsWall:
                ...
                if nextPosition in self.corners and nextPosition not in visitedCorners:
                    newCorner.append(nextPosition)
                successorState = (nextPosition, tuple(newCorner))
...
def cornersHeuristic(state, problem):
    ...
    for corner in corners:
        if corner not in unvisitedCorners:
    ...
    while unvisitedCorners:
        ...
        for corner in unvisitedCorners:
            ...
            dis.append((distance, corner))
        minDistance, closestCorner = min(dis, key=lambda x: x[0])
